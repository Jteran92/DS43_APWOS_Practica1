...
<div class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: teal;">
        <a class="navbar-brand" href="#"><bl>BibloJuegos</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('biblioJuegos.index')}}">Agregar Juego</a>
            </li>
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <h6 class="text-uppercase fw-bold mb-4">
              <i class="fas fa-gem me-3"></i>BiblioJuegos
            </h6>
            <p>
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="#!" class="text-reset">Generos</a>
            </p>
            <p>
              <a href="#!" class="text-reset">Plataformas</a>
            </p>
            <p>
              <a href="#!" class="text-reset">Tematicas</a>
            </p>
          </div>
          <!-- Grid column -->
